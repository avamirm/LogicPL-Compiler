...
public class LogicPLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "BOOL_VALUE", "VAR_TYPE", "FUNCTION", "MAIN", "INT", "FLOAT", 
			"BOOL", "TRUE", "FALSE", "PRINT", "FOR", "RETURN", "PRED_NAME", "INT_VALUE", 
			"FLOAT_VALUE", "LINE_COMMENT", "NON_DIGIT", "DIGIT", "LOWER_ALPH", "UPPER_ALPH", 
			"ID", "WHITE_SPACE", "LPAR", "RPAR", "LBRACE", "RBRACE", "MINUS", "PLUS", 
			"NOT", "MULT", "DIV", "MODE", "LT_EQ", "LT", "GT_EQ", "GT", "EQUAL", 
			"NOT_EQUAL", "ARROW_FUNC", "AND", "OR", "ASSIGN", "SEMICOLON", "COMMA", 
			"COLON", "DOT", "LBRACK", "RBRACK", "QUESTION_MARK", "NEW_LINE"
		};
	}
